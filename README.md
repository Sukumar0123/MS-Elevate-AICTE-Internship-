...
•	To identify patterns and trends in student scores.
•	To help educators compare student performance across different categories.
...
2 Data Cleaning
Unnecessary values and formatting issues were removed to ensure accurate analysis.
3 Data Analysis
Student scores were analyzed based on different attributes such as gender, ethnicity, and parental education level.
4 Dashboard Creation
An interactive dashboard was developed using Power BI to visualize the data.
...
•	Ethnicity-based score analysis
...
•	Easy comparison of scores across different categories
•	Identification of high-performing students
•	Improved data interpretation using visual charts
